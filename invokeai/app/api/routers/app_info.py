...
from invokeai.app.services.invocation_cache.invocation_cache_common import (
...
class Upscaler(BaseModel):
    ...
    upscaling_models: list[str] = Field(
...
class AppVersion(BaseModel):
    ...
    highlights: Optional[list[str]] = Field(
        default=None, description="Highlights of release"
    )
...
class AppConfig(BaseModel):
    ...
    watermarking_methods: list[str] = Field(
...
@app_router.get(
    "/app_deps",
    operation_id="get_app_deps",
    status_code=200,
    response_model=AppDependencyVersions,
)
